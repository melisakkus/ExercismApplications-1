...
namespace ExercismApplications
{
    static class AnnalynsInfiltration
    {
        ...
        public static bool CanFreePrisoner(bool knightIsAwake, bool archerIsAwake, bool prisonerIsAwake, bool petDogIsPresent)
        {
            ...
            bool x = petDogIsPresent && !archerIsAwake;
            bool y = !petDogIsPresent && prisonerIsAwake && !archerIsAwake && !knightIsAwake;
            return x || y;
        }
    }
}
...
//Free prisoner: Annalyn can try sneaking into the camp to free the prisoner. This is a risky thing to do and can only succeed in
//one of two ways:
...
//awake and the knight and archer are both sleeping, but if the prisoner is sleeping they can't be rescued: the prisoner would be
//startled by Annalyn's sudden appearance and wake up the knight and archer.
//You have four tasks: to implement the logic for determining if the above actions are available based on the state of the three
//characters found in the forest and whether Annalyn's pet dog is present or not.